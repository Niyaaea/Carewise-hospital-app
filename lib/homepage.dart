...
class homepage extends StatefulWidget {
  ...
  const homepage({Key? key, required this.Patient_ID, required String patient_ID}) : super(key: key);
    ...
    if (response.statusCode == 200) {
      ...
      if (appointmentsFound) {
        setState(() {
          ...
          waitingTime = jsonData['waiting_time']; 
          print(waitingTime);// Calculate waiting time
        });
      } else {
        setState(() {
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                Container(
                  width: 362,
                  height: hasAppointment ? 1366 : 1200, // Adjust height based on whether appointment exists
...
Positioned(
  ...
  child: GestureDetector(
    onTap: () {
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => Profile(Patient_ID: '',)),
      );
    },
    child: Container(
      width: 86,
